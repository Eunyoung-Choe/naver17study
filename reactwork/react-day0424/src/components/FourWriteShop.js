...
const FourWriteShop = ({onSave}) => {
    ...
    return (
        <div style={{width:'500px'}}>
            <input type='text' placeholder='상품명' value={sangpum}
                onChange={(e)=>setSangpum(e.target.value)}/>
            &nbsp;&nbsp;

            <input type='color' placeholder='상품가격' style={{width:'70px'}} value={color}
            ...
            <Button color='success' variant='contained' style={{margin:'10px 160px'}}
                onClick={addShopEvent}>
                추가
            </Button>
