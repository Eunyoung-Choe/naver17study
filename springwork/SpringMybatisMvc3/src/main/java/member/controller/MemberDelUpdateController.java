...
public class MemberDelUpdateController {
      ...
      @ResponseBody
      public void mypadgeDelete(@RequestParam int num,HttpSession session) {
      ...
      @ResponseBody
      public String updateMember(@RequestParam("num") int num,
                                 @RequestParam("mname") String mname,
                                 @RequestParam("mhp") String mhp,
                                 @RequestParam("maddr") String maddr) {
          // `num` 포함해서 서비스 메서드 호출
          memberService.updateMemberInfo(num, mname, mhp, maddr); 
          return "success";
      }
