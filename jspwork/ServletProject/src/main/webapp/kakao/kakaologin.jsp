   ...
   if(localStorage.loginok==null){
      ...
      <li onclick="kakaoLogout();">
            <a href="javascript:void(0)">
                ...
                <h5 class="logininfo" style="float:right;">\${localStorage.writer}님이 로그인중입니다.
...
<script>
Kakao.init('2e362293467d452e477890f8e86230f6'); //발급받은 키 중 javascript키를 사용해준다.
      ...
      success: function (response) {
        Kakao.API.request({
          ...
          success: function (response) {
             ...
             console.log(response.properties.thumbnail_image);//썸네일 사진
             
             //localStorage 에 닉네임,썸네일이미지,로그인상태 저장
