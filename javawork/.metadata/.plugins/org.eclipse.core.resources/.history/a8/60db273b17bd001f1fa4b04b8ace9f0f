...
public class Ex10Object {
	...
	public static void writeCar(int num, Car myCar)
	{
		...
		System.out.println(num+"\t"+myCar.getCarName()+"\t"+nf.format(myCar.getCarPrice())+"만 원");
	}

	public static void main(String[] args) {

		// 객체 배열
		Car []cars = new Car[5]; //메모리 할당 시 객체는 무조건 초기값 null (null이면 메서드 호출 불가)
		// 배열 5개의 각 Car 객체는 따로 생성해 주어야 함.
