...
@FunctionalInterface // 메서드가 하나인지 아닌지 검증하는 역할 (2개면 오류 발생)

interface Orange
{
	public void write(); // 추상 메서드 
//	public void study(); 메서드 2개 되어서 오류 
}
...
public class Ex2Lambda {
	...
	// 우리가 알고 있는 익명 내부 클래스 형태로 Orange를 구현해보자.
	...
	public void lambdaMethod()
	{
		...
		Orange orange2 = () -> System.out.println("헬로 람다");
		orange2.write();
